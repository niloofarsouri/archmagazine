        ...
        <>
            ...
            <section className="w-3/5 m-auto h-auto">
                <div className="w-full h-auto p-3 mb-20 grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2">
                    ...
                    <div className="card second-card w-[18rem] h-auto m-1 mr-7 lg:relative lg:m-0">
                    ...
                    <div className="card third-card w-[18rem] h-auto m-1 mr-7 lg:relative lg:m-0">
                    ...
                    <div className="card fourth-card w-[18rem] h-auto m-1 mr-7 lg:relative lg:m-0">
