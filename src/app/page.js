...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="w-full min-h-screen bg-[#2C4210] lg:bg-[#220C08]">

        <div className="w-full h-auto bg-[#220C08] md:h-[750px] hidden lg:block">
          <div className="w-full min-h-screen md:max-h-screen bg-[url(/backgroundSky.jpg)] bg-no-repeat bg-cover relative mb-60 flex justify-center items-center text-center ">
            <div className="w-full absolute top-0"><RootHeader /></div>

            <div className="absolute top-48 md:top-31">
              <p className="text-white lg:text-[250px] xl:text-[350px] opacity-55 text-center font-primary lg:top-40 xl:top-33 hidden lg:block">ARCH MAG</p>
              <p className="text-white text-[150px] md:text-[300px] opacity-55 text-center font-primary lg:hidden">ARCH</p>
            </div>
        ...
        <div className="w-full min-h-screen bg-[#203800] lg:bg-[#220C08] flex flex-col justify-center items-center">
      ...
      <div className="w-full flex justify-center items-center bg-[#203800] lg:bg-[#220C08]">
