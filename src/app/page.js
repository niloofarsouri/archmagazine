    ...
    <>
      ...
      <section className="w-full min-h-screen bg-[#220C08] ">
        ...
        <div className="w-full h-auto bg-[#220C08] md:h-[750px] hidden lg:block">
          <div className="w-full min-h-screen md:max-h-screen bg-[url(/backgroundSky.jpg)] bg-no-repeat bg-cover relative mb-60 flex justify-center items-center text-center ">
            ...
            <div className="absolute top-48 md:top-31">
              <p className="text-white lg:text-[210px] xl:text-[300px] opacity-55 text-center font-primary lg:top-40 xl:top-33 hidden lg:block">ARCH MAG</p>
              <p className="text-white text-[150px] md:text-[400px] opacity-55 text-center font-primary lg:hidden">ARCH</p>
            </div>
        ...
        <div className="w-full min-h-screen bg-[#220C08] flex flex-col justify-center items-center">
          ...
          <div className="w-3/5 h-auto mt-[210px] md:mt-[200px] flex-1/2 p-8 flex-col justify-center items-center text-white ">
