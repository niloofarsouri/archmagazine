...
export default function Layout({ children }) {
    ...
    return (
        ...
        <>
            ...
            <div className="text-[#080808] dark:text-white">
                {children}
                {/* <div className="w-full h-auto flex items-center justify-center text-white bg-[#080808]">
                    <div className="w-4/5 border-t-1">
                        <FooterTransparent />
                    </div>
                </div> */}

                <div className="flex justify-between items-center bg-[#261C0E] text-white ">
